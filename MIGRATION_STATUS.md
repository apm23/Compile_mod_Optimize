...
| Custom Hotbar Inventory | `custom-hotbar-inventory-1.0.0-tacz-workbench-multipage-fix-mc26.2(1).jar` | `apm23/custom-hotbar-inventory` | `dual/src/main/java/apm23/compilemod/dual/inventory/...` | Migration started with dependency-free input debounce + golden JUnit regression; storage/networking/client/TACZ compatibility still pending and will be migrated in isolated slices |
